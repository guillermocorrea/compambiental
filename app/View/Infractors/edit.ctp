...
<div class="span2 offset1 well">
	...
	<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Infractor.id')), array('class'=>'btn btn-danger'), __('Realmente desea eliminar esta Persona # %s?', $this->Form->value('Infractor.numero_documento'))); ?>
</div>
